            ...
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <p class="text-lg mb-3"><strong>Nome:</strong> {{ $morador->nome }}</p>
                        <p class="text-lg mb-3"><strong>Data de Cadastro:</strong> {{ $morador->data_cadastro }}</p>
                        <p class="text-lg mb-3"><strong>Unidade:</strong> {{ $morador->unidade['nome'] }}</p>
                        <p class="text-lg mb-3"><strong>Sexo:</strong> {{ $morador->sexo }}</p>
                        <p class="text-lg mb-3"><strong>CPF:</strong> {{ $morador->cpf }}</p>
                    </div>
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        ...
                        <a href="{{ route('moradores.edit', ['morador' => $morador->id]) }}"
